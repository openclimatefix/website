    ...
    <div className="bg-white">
      ...
      <section className="container px-4 mx-auto sm:p-0 mb-36">
        <article className="mx-auto mt-10 prose mb-36">
          ...
          <p>
            Our approach is to search for ML (Machine Learning) problems where,
            if we solve a well-defined ML task, then there is likely to be a
            large climate impact. Then, for each of these challenges, we will:
          </p>
          <ol>
            <li>
