  ...
  return (
    ...
    >
      <p className="pl-6 text-2xl border-l-4">
        ...
        move over PV panels, the power output moves up and down rapidly. We
        devised a solution to keep the balance.
      </p>
      <h2>Why?</h2>
      <p>
        Solar Photovoltaics (PV) is one of the most significant sources of
        uncertainty in the UK’s power forecasts. To mitigate against the risk of
        a large cloud sweeping across the country (and hence the grid losing
        gigawatts of PV generation), the Electricity System Operator (National
        Grid) keeps lots of natural gas generators operating at less than full
        capacity, so they have headroom to ramp up quickly (spinning reserve).
      </p>
      <p>
        ...
        hours to start up from cold, but they can be ramped up very quickly from
        idle. Spinning reserve costs a lot of money and pumps out a lot of CO2.
      </p>
      <figure>
        <img
      ...
      <p>
        ...
        onboarding of new PV generation farms, as the local and national system
        operators are concerned about these unexpected weather events
        destabilising the grid. By providing greater predictability of PV power
        output, we can make PV power investments lower risk for all
        stakeholders.
      </p>

      <h2>What?</h2>
      <p>
        Nowcasting is a bit of an odd term. It means &ldquo;forecasting for the
        next few hours&rdquo;. In general, nowcasting does not use the hugely
        complex and computationally-expensive numerical weather models that run
        on supercomputers and constitute the bread-and-butter for most
      ...
      <p>
        ...
        rainfall (because predicting floods saves lives and property).
      ...
      <p>
        ...
        cloud profiles, and geographical information. We will utilize the team’s
        experience in Machine Learning as well as contributors from the open
        source community to accelerate progress.
      </p>
      <p>
        As quickly as possible, we would like to get early-stage prototype PV
        forecasts displayed in the National Grid control room, to validate our
        model’s effectiveness and so we can start measuring the impact on
        emissions and cost. Beyond that we will release a nowcasting product for
