      ...
      <div className="px-6 container mx-auto md:max-w-2xl lg:max-w-2xl xl:max-w-2xl mb-16">
        ...
        <div className="prose">
          <p>
            ...
            . The Google.org Impact Challenge on Climate commits €10M to fund
            bold ideas that aim to use technology to accelerate Europe’s
            progress toward a greener, more resilient future. Selected
            organisations may receive up to €2M in funding and possible
            customised post-grant support from the Google for Startups
            Accelerator to help bring their ideas to life.
          </p>
          <p>
            ...
            concepts that use space tech. We asked potential users of
